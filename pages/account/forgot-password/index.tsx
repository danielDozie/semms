    ...
    <>
      <Head>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="py-4 text-xs font-light text-gray-800 dark:text-myGray">Enter your email address and we will send you an email with a link to reset the password to your account</p>
        </div>
