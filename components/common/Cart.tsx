        ...
        <div className="w-full" >
            ...
            <div className={`${isCart ? 'flex' : 'hidden'} z-20 block w-[80%] md:w-[35%] justify-end right-0 h-screen fixed bg-white dark:bg-black mt-[3.5em] md:mt-[6em]`}>
                <div className="w-full h-[100vh] mt-10 md:mt-[1em] mx-8 overflow-auto">
                    ...
                    {/* item section */}
                    <div className="flex flex-col max-h-[45%] overflow-y-scroll border-b-2 border-black dark:border-myGray">
                    <ItemSection />
                    <ItemSection />
                    <ItemSection />
    ...
    <div className="flex flex-col md:flex-row justify-between mt-8">
                        <div className="flex gap-x-4">
                            ...
                            <div className="flex flex-col gap-y-1">
                                ...
                                <div className="flex">
                                    <p className="text-[12px] md:text-[14px] mr-2 font-thin text-gray-800 dark:text-gray-300">Size</p>
