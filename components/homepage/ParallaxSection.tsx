                ...
                <div className="w-[80%] mx-auto px-0 md:px-4 py-16">
                    <div className="flex flex-col">
                        <div className="bg-white dark:bg-black w-full p-8 md:w-[60%] md:p-8 rounded-sm">
                            <h1 className="text-gray-600 dark:text-myGray text-xl font-medium">
                                Top Quality Leather Luggage Company
                            </h1>
                            <h1 className="text-gray-600 dark:text-myGray text-3xl  md:text-4xl font-bold uppercase py-4">
                                Established since 2019
                            </h1>
                            <p className="text-gray-500 dark:text-myGray  text-md">
