            ...
            <div className="flex flex-col-reverse my-16 md:flex-row">
                <div className="w-full md:w-[60%] ">
                    <div className="flex flex-col md:pr-8">
                        ...
                        <p className="pt-8 text-sm font-light text-gray-800 dark:text-myGray ">Semms luxuries is a brand of luggage, originally launched in 2019 and designed by our customization artist and lifestyle accessory designers. Semms focuses on bespoke luxury with a unique feel and look that speaks class.
We carry premium quality tested and trusted luggage, handbags, accessories, kids collections, and more. With a wide variety of brands, thousands of product, and customer-generated ratings and reviews, we are committed to helping our customers with the best travel bags and accessories at the right price. We pride ourselves on having the knowledge and experience to help our customers choose the very best in our product catalog.</p>
                        <div className="pt-8">
                            <Link href="/discover">
