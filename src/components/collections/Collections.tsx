            ...
            <div className="py-8">
                <div className="flex md:flex-row flex-col mx-auto">
                    {collections.map((collection:any) => (
                        <div className="bg-gold w-full mb-8 md:mr-4 h-[400px] bg-top bg-cover dark:bg-gray-900 drop-shadow-xl cursor-pointer" style={{ backgroundImage: `url(${collection?.node.image.src})` }} key={collection?.node.id}>
